...
class AllCurrencyAdapter(context: Context, private val countryList: List<AllCurrency>) :
    ArrayAdapter<AllCurrency>(context, 0, countryList) {
...
//            flagImageView.setImageResource(it.flagResId)
            countryNameTextView.text = it.currencyName
            flagImageView.text = it.currencyID
        }
